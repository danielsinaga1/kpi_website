        ...
        <div class="row">
          ...
          <div class="col-lg-4 col-md-6 footer-newsletter">
            ...
            <p>
              ...
              class="img-thumbnail">
              <br><br><strong><?php echo strtoupper($site->namaweb) ?></strong>
              <br><?php echo nl2br($site->alamat) ?>
              <br><i class="far fa-envelope"></i> : <?php echo $site->email ?>
              <br><i class="fas fa-phone"></i> : <?php echo $site->telepon ?>
              {{-- <br>HP <i class="fab fa-whatsapp"></i>: <?php echo $site->hp ?> --}}
              <br><i class="fas fa-globe"></i> : <?php echo $site->website ?>
            </p>
