...
Route::get('csr', 'Home@konten_csr');
Route::get('sejarah', 'Home@sejarah');
Route::get('pemegang-saham', 'Home@pemegang_saham');
Route::get('sertifikat-penghargaan', 'Home@sertikat_penghargaan');
Route::get('karir', 'Home@karir');
Route::get('data-fisik-produk', 'Home@data_fisik_produk');
Route::get('keselamatan-lingkungan', 'Home@keselamatan_lingkungan');
Route::get('galeri-pabrik', 'Home@galeri_pabrik');
Route::get('galeri-kantor-jakarta', 'Home@galeri_kantor_jakarta');
Route::get('galeri-kantor-pusat', 'Home@galeri_kantor_pusat');
